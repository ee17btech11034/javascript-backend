...
import registerUser, { changeCurrentPassword, getCurrentUser, getUserChannelProfile, getWatchHistory, loginUser, logoutUser, refreshAccessToken, updateUserAvatar, updateUserDetails } from "../controllers/user.controller.js";
...
router.route("/update-accounts").patch(verifyJWT, updateUserDetails)
